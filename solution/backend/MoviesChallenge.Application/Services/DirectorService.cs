...
public class DirectorService : IDirectorService
{
    ...
    public async Task<PagedResult<DirectorDto>> GetPaginatedAsync(PaginationParameters paginationParams)
    {
        var pagedDirectors = await _directorRepository.GetPaginatedAsync(paginationParams);
    ...
    public async Task<PagedResult<DirectorDto>> SearchDirectorsAsync(string param, PaginationParameters paginationParams)
    {
        var pagedDirectors = await _directorRepository.SearchByNameAsync(param, paginationParams);
        return new PagedResult<DirectorDto>
        {
            Data = pagedDirectors?.Data?.Select(a => new DirectorDto
            {
