...
public interface IDirectorService
{
    ...
    Task<PagedResult<DirectorDto>> GetPaginatedAsync(PaginationParameters paginationParams);

    Task<PagedResult<DirectorDto>> SearchDirectorsAsync(string param, PaginationParameters paginationParams);
